...
export interface Category { key: string; label: string; icon: string; special: boolean; }

export const CATEGORIES: Category[] = [
  { key: 'Sağlık', label: 'Sağlık', icon: '🩺', special: false },
  { key: 'Ekipman', label: 'Ekipman', icon: '🛠️', special: false },
  { key: 'Hijyen', label: 'Hijyen', icon: '🧼', special: false },
  { key: 'Giyim', label: 'Giyim', icon: '👕', special: false },
  { key: 'Enerji', label: 'Enerji', icon: '🔋', special: false },
  { key: 'Gıda ve Su', label: 'Gıda ve Su', icon: '🥫', special: false },
  { key: 'Ulaşım', label: 'Ulaşım', icon: '🚌', special: true },
  { key: 'Taşıma', label: 'Taşıma', icon: '🚚', special: true },
  { key: 'Evcil Hayvanlar', label: 'Evcil Hayvanlar', icon: '🐾', special: true },
];
...
export const emptyWizard = (loc: string): WizardValues => ({
...
export function buildPayload(v: WizardValues): NeedPayload {
  const base = { category: v.category, priority: v.priority, loc: v.loc, deadline: v.deadline };
