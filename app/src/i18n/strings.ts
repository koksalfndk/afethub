...
export const tr = {
  ...
  track: {
    ...
    mineEmptyBody: 'Bir afet sayfasındaki ihtiyaç kartından "Destek Ol" ile teslim sözü verebilir veya teslimat bildirebilirsiniz.',
    ...
    // Tek kutu, iki kayıt türü: teslimat bildirimi ve teslim sözü. Yalnızca birinden
    // söz etmek, elinde "SOZ-" ile başlayan bir kod olan kişiyi yanlış yere gönderirdi.
    intro: 'Teslimat bildiriminizin veya teslim sözünüzün takip kodunu girin.',
    code: 'Takip kodu',
    email: 'E-posta',
    trackBtn: 'Takip et',
  ...
  support: {
    ...
    willDeliver: 'Teslim Edeceğim',
    willDeliverDesc: 'Bu ürünü ulaştırmayı planlıyorum.',
    // İki cümle de aynı gerçeği söylüyor ama farklı yerden: biri sözün, diğeri
    // bildirimin miktara ne YAPMADIĞINI yazıyor (rules/01 §Transparency).
    willDeliverNote: 'Teslim sözünüz kalan ihtiyaç miktarını azaltmaz.',
    didDeliver: 'Teslim Ettim',
    didDeliverDesc: 'Ürünü teslim noktasına ulaştırdım.',
    didDeliverNote: 'Kalan ihtiyaç, koordinatör doğrulamasından sonra güncellenir.',
    close: 'Kapat',
    back: 'Geri',

    formTitle: 'Teslim Sözü Oluştur',
    planTitle: 'Teslim planı',
    contactTitle: 'İletişim bilgileri',
    need: 'İhtiyaç',
    qty: 'Miktar',
    unit: 'Birim',
    location: 'Teslim noktası',
    locationAny: 'Henüz belirlemedim',
    date: 'Tahmini teslim tarihi',
    time: 'Tahmini teslim saati',
    notes: 'Not',
    name: 'Ad Soyad',
    email: 'E-posta',
    phone: 'Telefon',
    city: 'Yaşadığınız şehir',
    whyContact: 'İletişim bilgileriniz yalnızca koordinasyon için kullanılır; herkese açık sayfalarda görünmez.',
    confirmTruth: 'Verdiğim bilgilerin doğru olduğunu onaylıyorum.',
    confirmContact: 'Koordinasyon amacıyla benimle iletişime geçilmesini kabul ediyorum.',
    notice: 'Teslim sözünüz kalan ihtiyaç miktarını azaltmaz. İhtiyaç miktarı yalnızca yardım fiziksel olarak teslim edildikten ve koordinatör tarafından doğrulandıktan sonra güncellenir.',
    submit: 'Teslim Sözü Oluştur',
    submitting: 'Gönderiliyor…',
    cancel: 'Vazgeç',
    overRemaining: (rem: number, unit: string) =>
      `Planladığınız miktar mevcut kalan ihtiyacın (${rem} ${unit}) üzerinde. Koordinasyon ekibi fazla miktarın başka bir ihtiyaca yönlendirilmesi için sizinle iletişime geçebilir.`,
    errQty: 'Miktar sıfırdan büyük olmalı.',
    errName: 'Ad soyad gerekli.',
    errEmail: 'Geçerli bir e-posta adresi girin.',
    errCity: 'Şehir gerekli.',
    errPast: 'Tahmini teslim zamanı geçmiş olamaz.',
    errConsent: 'Devam etmek için iki onayı da işaretleyin.',
    errGeneric: 'Teslim sözünüz oluşturulamadı. Girdiğiniz bilgiler korunuyor; lütfen tekrar deneyin.',
    errClosed: 'Bu ihtiyaç artık teslim sözü kabul etmiyor. Güncel ihtiyaçları görüntüleyebilirsiniz.',
    errSummary: 'Formda düzeltilmesi gereken alanlar var.',

    doneTitle: 'Teslim planınız kaydedildi',
    doneLead: 'Bu bildirim kalan ihtiyaç miktarını değiştirmez. Teslimat gerçekleştikten ve koordinatör tarafından doğrulandıktan sonra ihtiyaç güncellenir.',
    trackingCode: 'Takip kodu',
    copyCode: 'Takip kodunu kopyala',
    copied: 'Takip kodu kopyalandı.',
    copyFailed: 'Kopyalanamadı. Kodu seçip elle kopyalayabilirsiniz.',
    viewPlan: 'Teslim planımı görüntüle',
    supportAnother: 'Başka bir ihtiyaç için destek ol',
    accountOffer: 'Sonraki işlemlerde bilgilerinizi yeniden girmemek için isteğe bağlı hesap oluşturabilirsiniz.',

    statusLabel: {
      pledged: 'Teslim sözü verildi',
      confirmed: 'Koordinasyon ekibiyle teyit edildi',
      in_transit: 'Yolda',
      delivered_reported: 'Teslim bildirildi',
      fulfilled: 'Tamamlandı',
      cancelled: 'İptal edildi',
      expired: 'Süresi doldu',
    } as Record<string, string>,
    statusHelp: {
      pledged: 'Teslim planınız kaydedildi.',
      confirmed: 'Teslim planınız koordinasyon ekibi tarafından teyit edildi.',
      in_transit: 'Yardımınız teslim noktasına doğru yolda olarak işaretlendi.',
      delivered_reported: 'Teslimat bildiriminiz koordinatör doğrulaması bekliyor.',
      fulfilled: 'Teslimat doğrulandı ve işlem tamamlandı.',
      cancelled: 'Teslim planı iptal edildi.',
      expired: 'Tahmini teslim zamanı geçtiği için planın süresi doldu.',
    } as Record<string, string>,

    trackEta: (t: string) => `Tahmini teslim: ${t}`,
    cancelPlan: 'Planımı İptal Et',
    cancelTitle: 'Teslim planını iptal etmek istiyor musunuz?',
    cancelLead: 'Bu işlem ihtiyaç miktarını etkilemez.',
    cancelReason: 'İptal nedeni (isteğe bağlı)',
    cancelReasons: ['Planım değişti', 'Ürünü temin edemedim', 'Teslim noktasına ulaşamıyorum', 'Başka bir ihtiyaca destek olacağım', 'Diğer'],
    cancelConfirm: 'Planı İptal Et',
    cancelKeep: 'Vazgeç',
    cancelled: 'Teslim planınız iptal edildi. İhtiyaç miktarı bu işlemden etkilenmedi.',
    cancelFailed: 'Teslim planı iptal edilemedi. Lütfen tekrar deneyin.',
    // Bağlantı Faz 3-C'de; şimdilik bunun AYRI bir bildirim olduğu açıkça yazılıyor.
    reportDelivery: 'Teslim ettim olarak bildir',
    // Ne yapıldığı olduğu gibi yazılıyor: eskiden "bilgileriniz forma önceden
    // doldurulur" deniyordu ama takip yanıtı ad, telefon ve şehir taşımıyor —
