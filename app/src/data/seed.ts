...
export const announcements: Announcement[] = [
  ...
  { id: 'a2', disasterId: 'd1', kind: 'Lojistik', accent: '#F97316', time: '1 saat önce', author: 'Hakan Öz', title: "İkinci teslim noktası 20:00'de açılıyor", body: 'Çamlıyayla Okul Spor Salonu bu akşam ekipman, giyim ve pil kabul etmeye başlıyor. Ambulans şeridini açık tutmak için araçları doğu kapısından alın.' },
  { id: 'a3', disasterId: 'd1', kind: 'Çözüldü', accent: '#159947', time: '4 saat önce', author: 'Elif Kaya', title: 'İçme suyu ihtiyacı tamamen karşılandı', body: 'Teşekkürler — 12.000 litre doğrulandı. Depo tıbbi malzemeler için boş kalsın diye lütfen su göndermeyi durdurun.' },
  { id: 'a4', disasterId: 'd2', kind: 'Lojistik', accent: '#F97316', time: '40 dakika önce', author: 'Deniz Aksoy', title: 'İç yollar kapalı, teslimatı sahil yolundan yapın', body: 'Çukurbağ yönündeki yol müdahale ekiplerine ayrıldı. Kültür merkezine sahil yolundan ulaşın; giriş masası 21:00 civarında kapanıyor.' },
  { id: 'a5', disasterId: 'd3', kind: 'Kritik güncelleme', accent: '#D9363E', time: '2 saat önce', author: 'Burak Şen', title: 'Duman yerleşim yerine indi: maske ve göz damlası', body: 'Rüzgâr yön değiştirdi. Solunum ve göz şikâyeti artıyor; öncelik FFP2 maske, göz damlası ve serum fizyolojik.' },
  { id: 'a6', disasterId: 'd5', kind: 'Lojistik', accent: '#F97316', time: '3 saat önce', author: 'Aylin Doğan', title: 'Temizlik ve kurutma aşaması başladı', body: 'Su çekildi. Şu an en çok temizlik malzemesi, su motoru ve çizme gerekiyor. Gıda kolileri Bozkurt merkezine, yatak-battaniye İnebolu’ya bırakılmalı.' },
];
