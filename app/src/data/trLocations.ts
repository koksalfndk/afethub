...
//
// Kaynak: npm `turkey-city-regions` (PTT posta kodu veri seti) — il/ilçe alanları
// çıkarıldı, tekilleştirildi ve Türkçe büyük/küçük harf kurallarına göre normalize
// edildi. Üretim betiği bilinçli olarak tek seferlik: veri statik ve nadiren değişir.
//
// Otomatik üretildi — elle düzenlemeyin.
